...
# Storage and Cost Guardrails Stack
storage_stack = StorageStack(
    app,
    "ContextAnchorStorageStack",
    env=env,
    description="S3 storage and cost guardrails for ContextAnchor"
)

# Add tags to all stacks
for stack in [dynamodb_stack, lambda_stack, api_stack, storage_stack]:
